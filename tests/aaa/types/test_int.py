...
@pytest.mark.parametrize(
    ...
    [
        ...
        pytest.param("6 3 / . .", "true2", [], id="devide-ok-evenly"),
        pytest.param("7 3 / . .", "true2", [], id="devide-ok-unevenly"),
        pytest.param("7 0 / . .", "false0", [], id="devide-by-zero"),
        pytest.param("7 3 % . .", "true1", [], id="modulo-ok"),
        pytest.param("7 0 % . .", "false0", [], id="modulo-zero"),
