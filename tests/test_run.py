...
@pytest.mark.parametrize(
    ...
    [
        ...
        ('"abc" strlen .', "3"),
        ("true if nop end 3 .", "3"),
        ("false if nop end 3 .", "3"),
        ("true if 1 . end 3 .", "13"),
        ("false if 1 . end 3 .", "3"),
        ("true if nop else nop end 3 .", "3"),
        ("false if nop else nop end 3 .", "3"),
        ("true if 1 . else nop end 3 .", "13"),
        ("false if 1 . else nop end 3 .", "3"),
        ("true if nop else 2 . end 3 .", "3"),
        ("false if nop else 2 . end 3 .", "23"),
        ("true if 1 . else 2 . end 3 .", "13"),
        ("false if 1 . else 2 . end 3 .", "23"),
        ("true while false end 3 .", "3"),
        ("false while nop end 3 .", "3"),
        ("nop", ""),
    ],
)
