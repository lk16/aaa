...
PARSE_MODEL_TEST_VALUES: list[tuple[type[AaaParseModel], str, bool]] = [
    ...
    (ForeachLoop, "foreach", False),
    (FreeFunctionCall, "", False),
    (FreeFunctionCall, "3", False),
    (FreeFunctionCall, "bar", True),
    (FreeFunctionCall, "bar[int,]", True),
    (FreeFunctionCall, "bar[int]", True),
    (FreeFunctionCall, "bar[vec[int],]", True),
    (FreeFunctionCall, "bar[vec[int]]", True),
    (FreeFunctionCall, "foo:bar", False),
    (FreeFunctionName, "", False),
    (FreeFunctionName, "3", False),
    (FreeFunctionName, "bar", True),
    (FreeFunctionName, "bar[A,]", True),
    (FreeFunctionName, "bar[A]", True),
    (FreeFunctionName, "bar[vec[int]]", False),
    (FreeFunctionName, "foo:bar", False),
    (Function, "3", False),
    ...
    (MatchBlock, "match", False),
    (MemberFunctionCall, "", False),
    (MemberFunctionCall, "3", False),
    (MemberFunctionCall, "bar", False),
    (MemberFunctionCall, "foo:bar", True),
    (MemberFunctionCall, "foo:bar[int]", True),
    (MemberFunctionCall, "foo[int]:", False),
    (MemberFunctionCall, "foo[int]:bar", True),
    (MemberFunctionName, "", False),
    (MemberFunctionName, "3", False),
    (MemberFunctionName, "bar", False),
    (MemberFunctionName, "foo:bar", True),
    (MemberFunctionName, "foo[A,]:bar", True),
    (MemberFunctionName, "foo[A]:bar", True),
    (MemberFunctionName, "foo[A]:bar[B]", False),
    (MemberFunctionName, "foo[vec[int]]:bar", False),
    (ReturnTypes, "", False),
    (ReturnTypes, "3", False),
