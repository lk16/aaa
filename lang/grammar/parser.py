...
TERMINAL_RULES: List[TokenDescriptor] = [
    ...
    Regex(Terminal.COMMA, ",(?=\\W|$)"),
    Regex(Terminal.DROP, "drop(?=\\W|$)"),
    Regex(Terminal.DUP, "dup(?=\\W|$)"),
    Regex(Terminal.EQUALS, "=(?=\\W|$)"),
    Regex(Terminal.GREATER_EQUALS, ">=(?=\\W|$)"),
    Regex(Terminal.GREATER_THAN, ">(?=\\W|$)"),
    Regex(Terminal.LESS_EQUALS, "<=(?=\\W|$)"),
    Regex(Terminal.LESS_THAN, "<(?=\\W|$)"),
    Regex(Terminal.MINUS, "-(?=\\W|$)"),
    Regex(Terminal.NOP, "nop(?=\\W|$)"),
    Regex(Terminal.NOT, "not(?=\\W|$)"),
    Regex(Terminal.NOT_EQUALS, "!=(?=\\W|$)"),
    Regex(Terminal.OR, "or(?=\\W|$)"),
    Regex(Terminal.OVER, "over(?=\\W|$)"),
    Regex(Terminal.PERCENT, "%(?=\\W|$)"),
    Regex(Terminal.PERIOD, "\\.(?=\\W|$)"),
    Regex(Terminal.PLUS, "\\+(?=\\W|$)"),
    Regex(Terminal.ROT, "rot(?=\\W|$)"),
    Regex(Terminal.SLASH, "/(?=\\W|$)"),
